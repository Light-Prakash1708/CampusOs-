      ...
      <Card>
        <CardBody>
          <Alert tone="warning" title="No category is open to faculty">
            Your institution has not enabled any redressal category that faculty may raise. Ask
      ...
      <Card>
        <CardBody>
          ...
          <div className="mt-3 flex gap-2">
            <Button
              variant="primary"
              onClick={() => router.push(`/faculty/redressal/${mutation.data!.id}`)}
            >
              Open the case
            </Button>
            <Button variant="secondary" onClick={() => router.push('/faculty/redressal')}>
              Back to all cases
            </Button>
          </div>
        </CardBody>
    ...
    <Card>
      ...
      <CardFooter>
        <div className="flex gap-2">
          ...
          <Button variant="ghost" onClick={() => router.push('/faculty/redressal')}>
            Cancel
          </Button>
        </div>
      </CardFooter>
