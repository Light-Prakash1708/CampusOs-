...
export const metadata = { title: 'Readdressal · CampusOS' };
    ...
    return (
      <div>
        ...
        <Alert tone="warning" title="This module is not enabled for your institution">
          The Readdressal Centre is switched off in your institution&rsquo;s settings.
        </Alert>
      </div>
    );
  }
      ...
      <PageHeader
        ...
        action={
          <Button asChild variant="primary" icon={Plus}>
            <Link href="/faculty/readdressal/new">Raise a case</Link>
          </Button>
        }
      />
