...
export const metadata = { title: 'Redressal' };
      ...
      <PageHeader
        ...
        action={
          <Button asChild variant="primary" icon={Plus}>
            <Link href="/student/redressal/new">Raise a case</Link>
          </Button>
        }
      />
...
function CaseCard({ item }: { item: CaseRow }) {
  ...
  return (
    <Card>
      <CardBody>
        <Link href={`/student/redressal/${item.id}`} className="group block">
