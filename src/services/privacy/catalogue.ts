...
export const DATA_CATEGORIES: DataCategory[] = [
  ...
  },
  {
    ...
    stored: ['Habits and the check-ins you log (with an optional amount and note)', 'Your to-do list'],
  ...
  },
  {
    key: 'goals',
    label: 'Goals',
    stored: ['Goals you set, their steps, and whether you completed them'],
  ...
  },
  {
    ...
    stored: ['XP from verified activity (events you were checked in at, certificates)', 'XP from your own tracker (check-ins, goals, streaks, weekly challenges)', 'Badges'],
    usedFor: ['Your level and progress view', 'Leaderboards, only if you opt in — and only verified XP ever ranks you'],
    ...
    deletionPolicy: 'Tracker-based XP and badges are deleted with your tracker data; everything is deleted with your account.',
    exportPolicy: 'Included in your data export.',
  ...
  },
  {
    ...
    stored: ['Listings you saved and the status you set (applied, interviewing, offer …) with your notes', 'Opportunities you shared for approval'],
    usedFor: ['Your own application tracker', 'Reminding you before a saved listing closes'],
    visibleTo: ['Only you', 'Administrators see how many students applied to a listing — never who'],
    canDisable: 'yes',
    disableNote: 'Clear a status to stop tracking a listing.',
    owner: 'Student',
    retentionDays: null,
    retentionNote: 'While your account exists.',
    deletionPolicy: 'Your tracker is deleted with your account; listings you shared stay as college records.',
    exportPolicy: 'Included in your data export.',
